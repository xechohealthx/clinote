...
class ClinotePopup {
  ...
  downloadInstaller() {
    ...
    if (userAgent.includes('Windows')) {
      ...
      downloadUrl = `${baseUrl}/Clinote-Whisper-Server.dmg`;
      filename = 'Clinote-Whisper-Server.dmg';
    } else {
    ...
    chrome.downloads.download({
      ...
      if (chrome.runtime.lastError) {
        ...
        this.showNotification('Download started! Double-click the DMG file to install.', 'success');
      }
    });
  }
